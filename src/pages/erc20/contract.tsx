    ...
    <div className="bg-light min-vh-100 d-flex flex-row align-items-center dark:bg-transparent">
      <Container>
				...
				<Form.Group className="p-3 border border-dark rounded bg-light-grey">
					...
					<Row>
						<Col xs={9}><input type="email" className="form-control form-control-lg color-frame bg-yellow text-left border-0" disabled={!isDisconnected} value={TOKEN_ADDRESS || ''}></input></Col>
						<Col><Button type="submit" className="w-100 btn-lg bg-button-connect p-2 fw-bold" disabled={!isDisconnected} onClick={connectTokenContract}>Connect</Button></Col>
					</Row>
					<Row>
						<Col><div><Form.Text className="">Token Contract Owner</Form.Text></div></Col>
					</Row>
					<Row>
						<Col xs={9}><input id="tokenowner" type="email" className="form-control form-control-lg bg-yellow color-frame border-0" value={TOKEN_OWNER} disabled={!isDisconnected}></input></Col>
						<Col><Button type="submit" className="d-flex justify-content-center w-100 btn-lg bg-button p-2 fw-bold border-0" disabled={!isDisconnected} onClick={() => setNewTokenOwner('tokenowner')}> {KEY_ICON()} Update</Button></Col>
					</Row>
				</Form.Group>
