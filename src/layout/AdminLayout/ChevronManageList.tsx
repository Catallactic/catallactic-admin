  ...
  return (
		<div className='m-2'>
			<Row className='overflow-x-auto d-flex flex-row flex-nowrap'>
				...
				<Col className='m-0 p-0 cursor-pointer'><img src={`data:image/svg+xml;utf8,${encodeURIComponent(Chevron('Deploy'))}`} /></Col>
				<Col className='m-0 p-0 cursor-pointer'><img src={`data:image/svg+xml;utf8,${encodeURIComponent(Chevron('Manage'))}`} /></Col>
