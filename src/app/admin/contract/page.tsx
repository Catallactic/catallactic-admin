    ...
    <div className="bg-page d-flex flex-row align-items-center dark:bg-transparent">
      <Container className='mw-100'>
				...
				<Form.Group className="p-5 rounded-5 bg-group">
					...
					<Row>
						<Col><div><Form.Text className="fs-6">Contract Address</Form.Text></div></Col>
					</Row>
					<Row>
					...
					<Row>
						<Col><div><Form.Text className="fs-6">Contract Owner</Form.Text></div></Col>
					</Row>
					<Row>
					...
					<Row>
						<Col><div><Form.Text className="fs-6">Pending Contract Owner</Form.Text></div></Col>
					</Row>
					<Row>
				...
				<Form.Group className="p-5 rounded-5 bg-group">
					<Row>
						<Col><div><div className="color-frame fs-4 text-center text-center w-100">Token Balances</div></div></Col>
					</Row>
					<Row className="m-2"></Row>
					<Row>
